define(['underscore-contrib', 'jquery', 'windows', 'ko', 'app/main-window', 'app/tag-types', 'app/class-tag-types'], function(_, $, windows, ko, main_window, tag_types, class_tag_types){
